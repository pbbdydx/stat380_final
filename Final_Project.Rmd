...
There were 364 NA values in the game_type column and 31 score values that were NA. There could have been some overlapping also.  


Next we need to do some EDA and look at relationships between the variables. We will make a few different visualizations.
...
Looking at the plots here, we can see a positive correlation between score and total xp for all the game types. As the score increases, the total xp will also increase. For some game types, the slope is steeper meaning there might be a evidence that some game modes give more xp per score compared to others. 
